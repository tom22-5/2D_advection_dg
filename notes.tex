...
\begin{align*}
G_{ji^L} \approx \quad &\sum_q w_q \frac{1}{2} (y_1 - y_0) \phi_{j_0}(-1) \phi_{j_1}(x_q) (a(x_0(-1), x_1(x_q), t) \cdot n) \phi^L_{i_0}(-1) \phi^L_{i_1}(x_q) u^L_i\end{align*}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.85\textwidth]{rk_explicit_convergence.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.85\textwidth]{rk_implicit_convergence_precon.png}
